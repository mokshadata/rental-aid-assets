...
function addHeadersToAMITables(el) {
  ...
  var headerHTML = '<div class="list-grid-link no-padding w-dyn-item" style="opacity: 1;"><div class="w-row smaller-text"><div class="w-col w-col-4"><div>' + 
    numHousefholdHeading + '</div></div><div class="w-col w-col-8"><div>' +
